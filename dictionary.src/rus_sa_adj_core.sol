...
patterns ГруппаПрил0 { language=Russian } export { node:root_node РОД ПАДЕЖ ЧИСЛО ОДУШ }

pattern ГруппаПрил0
{
 прилагательное:* { ~КРАТКИЙ СТЕПЕНЬ:АТРИБ } :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
}
...
pattern ГруппаПрил0
{
 a1=прилагательное:* { ~КРАТКИЙ СТЕПЕНЬ:АТРИБ ТИП_ПРИЛ:ПОРЯДК } :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
 t='-'
...
pattern ГруппаПрил0
{
 a=прилагательное:* { ~КРАТКИЙ СТЕПЕНЬ:АТРИБ } :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
 attr=Детализатор
...
/*
 ...
 pattern ГруппаПрил0
 {
  ...
  adj=прилагательное:* { ~КРАТКИЙ СТЕПЕНЬ:АТРИБ } :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
 } : links { adj.<NEXT_COLLOCATION_ITEM>w2.<NEXT_COLLOCATION_ITEM>w1 }
*/

wordentry_set НеВтораяЧастьПрил=прилагательное:{ тот }

// в различных Восточных и Средне-Западных университетах.
//                         ^^^^^^^^^^^^^^^
pattern ГруппаПрил0
{
 prefix=*:*{} // TODO: возможно, надо оформить возможные префиксы
 t='-'{ tokenizer_flag:word_conjunction }
 a=прилагательное:* { ~КРАТКИЙ СТЕПЕНЬ:АТРИБ ~НеВтораяЧастьПрил } :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
} : links
{
 a.<PREFIX_PARTICLE>t.<NEXT_COLLOCATION_ITEM>prefix
}
...
pattern ГруппаПрил0
{
 ...
 t='-'{ tokenizer_flag:word_conjunction }
 a2=прилагательное:* { ~КРАТКИЙ СТЕПЕНЬ:АТРИБ =a1:ПАДЕЖ =a1:РОД =a1:ЧИСЛО =a1:ОДУШ } :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
} : links
{
...
pattern ГруппаПрил0
{
 @regex_strict("[\\@А\\@Б\\@Й](.*)ского") :export { node:root_node РОД ЧИСЛО:ЕД ПАДЕЖ:РОД ОДУШ:НЕОДУШ }
}
: ngrams { -1 }
...
pattern ГруппаПрил0
{
 @regex_strict("[\\@А\\@Б\\@Й](.*)ском") :export { node:root_node РОД ЧИСЛО:ЕД ПАДЕЖ:ПРЕДЛ ОДУШ:НЕОДУШ }
}
: ngrams { -1 }
...
pattern ГруппаПрил0
{
 a=прилагательное:какой { ~КРАТКИЙ СТЕПЕНЬ:АТРИБ } :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
...
pattern ГруппаПрил0
{
 a=прилагательное:один { ~КРАТКИЙ СТЕПЕНЬ:АТРИБ } :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
 m=наречие:лишь{}
} : links { a.<ATTRIBUTE>m }
  : ngrams { -1 }
...
pattern ГруппаПрил0
{
 a=прилагательное:* { ~КРАТКИЙ СТЕПЕНЬ:ПРЕВОСХ } :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
 p=частица:же{}
} : links { a.<POSTFIX_PARTICLE>p }
...
pattern ГруппаПрил0
{
 ...
 adj=прилагательное:* { ~КРАТКИЙ СТЕПЕНЬ:АТРИБ ~CanAdjModifByAdv } :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
}
...
pattern ГруппаПрил0
{
 ...
 adj=ПритяжПрилагМестоим :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
}
: links { adj.<ATTRIBUTE>adv }
...
pattern ГруппаПрил0
{
 a=прилагательное:* { ПЕРЕХОДНОСТЬ:ПЕРЕХОДНЫЙ ~ПРИЧАСТИЕ ~КРАТКИЙ СТЕПЕНЬ:АТРИБ } :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
...
pattern ГруппаПрил0
{
 ...
 a=прилагательное:* { ПЕРЕХОДНОСТЬ:ПЕРЕХОДНЫЙ ~ПРИЧАСТИЕ ~КРАТКИЙ =ПАДЕЖВАЛ->obj:ПАДЕЖ СТЕПЕНЬ:АТРИБ } :export { node:root_node РОД ЧИСЛО ПАДЕЖ ОДУШ }
}
: links { a.<OBJECT>obj }
: ngrams { -5 }
...
patterns Нареч0 { language=Russian } export { СТЕПЕНЬ node:root_node }
...
pattern КраткПрил1
{
 mod=ГруппаНареч1{ СопоставлНаречПрил }
 p=частица:же{}
 a=КраткПрил0 : export { node:root_node РОД ЧИСЛО ПРИЧАСТИЕ СТРАД ПАДЕЖВАЛ ПЕРЕХОДНОСТЬ }
 comma1=','
 comp=наречие:как{}
